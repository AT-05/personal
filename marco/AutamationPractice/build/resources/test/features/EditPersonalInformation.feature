...
Feature: editPersonalInfo
  ...
  Background:
    Given I navigate to login page and Sing In  with email "pedro.pablo@gmail.com" and password "holamundo123"
  ...
  Scenario Outline: this scenario update the information personal of an account
    ...
    Examples:
      ...
      | Marco Antonio | Mendez Rocha     | holamundo123 | holamundo123 | holamundo123 | pedro.pablo@gmail.com | 10  | 10    | 2000 |
